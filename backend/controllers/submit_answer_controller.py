...
from utils.chat_history_service import get_answered_question
...
async def process_answer(
    ...
    # disabled the if you know you know response, the node will be red but not blocking
    # # Determine response
    # if score < 50:
    ...
    chat_history = get_answered_question(db, session_id, current_user.id)
