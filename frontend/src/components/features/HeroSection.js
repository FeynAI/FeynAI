...
export default function HeroSection() {
  return (
    <div className="w-full max-w-[1440px] flex flex-col px-4 md:px-6 lg:px-8">
      <div className="relative">
        ...
        <div className="absolute left-4 md:left-12 lg:left-24 xl:left-36 top-1/2 transform -translate-y-1/2 text-white z-10 w-[90%] md:w-2/3 lg:w-auto">
          <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-2">If you know, you know.</h1>
